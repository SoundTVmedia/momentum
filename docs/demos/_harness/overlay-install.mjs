export function installDemoOverlay() {
  ...
  status.innerHTML =
    '<span>9:41</span><div class="demo-status-right">' +
  ...
  window.__demoCallout = (text) => {
    callout.classList.toggle('cam', Boolean(document.querySelector('.native-capture-modal')));
    if (!text) {
