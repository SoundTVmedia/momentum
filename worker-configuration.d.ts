// @ts-nocheck
/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a00469bf7c3a5c7c5bcbecb16d3c0772)
// This bundle re-declares worker runtime globals. Without @ts-nocheck, editors that load DOM lib show hundreds of duplicate-identifier errors. Re-add line 1 after `wrangler types` if removed.
// Runtime types generated with workerd@1.20260504.1 2025-06-17 nodejs_compat
