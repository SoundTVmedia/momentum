...
app.post("/api/program-applications", optionalAuthMiddleware, programApplications.submitProgramApplication);
app.get("/api/program-applications/me", authMiddleware, programApplications.getMyProgramApplications);
app.get("/api/admin/program-applications", authMiddleware, programApplications.getAdminProgramApplications);
app.post("/api/admin/program-applications/:applicationId/review", authMiddleware, programApplications.reviewProgramApplication);
app.post("/api/program-applications/brand-asset", authMiddleware, rateLimiter(RateLimits.UPLOAD), programApplications.uploadBrandAsset);
