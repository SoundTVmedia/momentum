      ...
      {compact ? (
        <div className="flex items-center space-x-2">
          {displayBadges.map((badge) => (
            <div
              key={badge.id}
              className="w-8 h-8 bg-gradient-to-br from-momentum-ember to-momentum-flare rounded-full flex items-center justify-center"
              title={badge.name}
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {badges.map((badge) => (
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-br from-momentum-ember to-momentum-flare rounded-full flex items-center justify-center mx-auto mb-2">
