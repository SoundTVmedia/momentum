      ...
      <div className="pointer-events-none relative z-20 flex min-h-[13.5rem] flex-col items-center justify-center px-4 py-6 sm:min-h-[20rem] sm:px-6 sm:py-10 lg:min-h-[24rem]">
        ...
        {slide && profileHref ? (
          <Link
            to={profileHref}
            onClick={onNavClick}
            className="pointer-events-auto mt-3 flex items-center justify-center gap-3 rounded-full px-2 py-1 hover:opacity-90 sm:mt-5"
          >
            <UserAvatar
      ...
      {eventTitle || artistName ? (
        canLinkShow ? (
          <Link
            to={showHref}
            onClick={onNavClick}
            className="absolute bottom-8 left-4 z-20 max-w-[min(22rem,calc(100%-5.5rem))] text-left drop-shadow-lg sm:bottom-11 sm:left-6"
          ...
          <div className="absolute bottom-8 left-4 z-20 max-w-[min(22rem,calc(100%-5.5rem))] text-left drop-shadow-lg sm:bottom-11 sm:left-6">
            {eventTitle ? (
              <p className="text-sm font-bold leading-snug text-white line-clamp-2 sm:text-base">
                {eventTitle}
              </p>
