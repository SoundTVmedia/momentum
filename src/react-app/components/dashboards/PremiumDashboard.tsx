      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-2">
            <Crown className="w-10 h-10 text-momentum-ember" />
            <h1 className="text-4xl font-bold text-white">
              Welcome Back, {displayName}
            </h1>
            <div className="px-4 py-2 momentum-grad-interactive rounded-full">
        ...
        {/* Membership Status */}
        <div className="bg-gradient-to-r from-momentum-ember/15 to-momentum-flare/15 border border-momentum-ember/30 rounded-xl p-6 mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-momentum-ember text-sm mb-1">Renews on</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <button className="momentum-grad-interactive rounded-xl p-6 hover:scale-105 transition-transform">
            <Ticket className="w-8 h-8 text-white mb-2" />
            <div className="text-white font-bold">Early Tickets</div>
            <div className="text-white/80 text-sm">First access</div>
          </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="glass-panel border border-momentum-ember/20 rounded-xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Crown className="w-6 h-6 text-momentum-ember" />
            </div>
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end">
                  <div className="p-4 w-full bg-black/60">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-momentum-ember text-xs font-medium">EXCLUSIVE</span>
                    </div>
          ...
          <div className="glass-panel border border-momentum-ember/20 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gradient-to-r from-momentum-ember/10 to-momentum-flare/10 rounded-lg border border-momentum-ember/25">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Calendar className="w-5 h-5 text-momentum-ember" />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-momentum-ember text-xs font-medium mb-1">EARLY ACCESS</div>
              ...
              <div className="p-4 bg-white/5 rounded-lg border border-white/10">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-momentum-ember text-xs font-medium mb-1">PRESALE ACTIVE</div>
              ...
              <div className="p-4 bg-white/5 rounded-lg border border-white/10">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-momentum-ember text-xs font-medium mb-1">EARLY BIRD</div>
        ...
        <div className="mt-8 glass-panel border border-momentum-ember/20 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Gift className="w-6 h-6 text-momentum-ember" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="p-4 bg-white/5 rounded-lg border border-white/10">
                <div className="w-full h-32 bg-gradient-to-br from-momentum-ember/15 to-momentum-flare/15 rounded-lg mb-3"></div>
                <div className="text-white font-bold mb-1">{item.name}</div>
                <div className="flex items-center justify-between">
                  <span className="text-momentum-ember font-bold">{item.price}</span>
                  <span className="text-gray-400 text-xs">{item.stock}</span>
                </div>
                <button className="w-full mt-3 px-4 py-2 momentum-grad-interactive rounded-lg font-medium text-white hover:scale-105 transition-transform">
                  Shop Now
                </button>
              </div>
            ))}
