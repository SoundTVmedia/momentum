  ...
  return (
    ...
    <div className={`relative group/carousel ${className}`}>
      <div
        ...
        className={`flex overflow-x-auto overflow-y-hidden overscroll-x-contain overscroll-y-none touch-pan-x scroll-smooth scrollbar-hide snap-x snap-mandatory pb-1 max-md:scroll-ps-0 max-md:scroll-pe-4 md:pl-0 md:pr-10 md:scroll-pl-0 ${filmstrip ? CLIP_CAROUSEL_GAP_CLASS : 'max-md:gap-3 gap-0 md:gap-4'} ${stretchItems ? 'items-stretch' : 'items-start'}`}
      >
        {children}
      </div>
