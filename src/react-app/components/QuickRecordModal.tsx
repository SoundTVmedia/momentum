    ...
    return (
      <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black px-6 text-center">
        ...
        <button
          ...
          className="w-full max-w-xs rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-6 py-4 font-semibold text-white active:scale-[0.98] transition-transform disabled:opacity-60"
          onClick={() => {
