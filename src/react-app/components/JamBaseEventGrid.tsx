...
import { jamBaseEventInProgress, jamBaseEventShouldOfferTickets } from '@/shared/jambase-event-day';
...
function JamBaseEventCard({
  ...
  const ticket = jamBaseEventShouldOfferTickets(event) ? primaryTicketUrl(event) : null;
